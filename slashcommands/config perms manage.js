...
const run = async (client, interaction) => {
    ...
    try {
        settings.set(key, permissions, "permsManage");
    } catch (error) {
    ...
    return interaction.reply(`Manage permissions have succesfully been changed to ${permissions}`)
}

module.exports = {
    data: new SlashCommandBuilder().setName("perms-manage").setDescription("Sets the permission to manage the gag-bot."),
    name: "perms-manage",
    description: "Sets the permission to manage the gag-bot.",
    perm: "manageperms",
    options: [
        {
            name: "permission",
