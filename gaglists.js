...
const ballGagTable = {
    ...
    q: {standard: "g"},
    r: {standard: "r"},
    s: {standard: "p", closer: "h"}, 
    t: {standard: "p", closer: "h"},
    u: {standard: "n"},
    v: {standard: "f"},
    w: {standard: "mm"},
    x: {standard: "g", closer: "h"}, 
    y: {standard: "m"},
    z: {standard: "p", closer: "h"},
    // NUMBERS
    0: {standard: "phmrn"},
    1: {standard: "nnm"},
    2: {standard: "phmmn"},
...
const ringGagTable = {
    ...
    h: {standard: "h"},
    i: {standard: "i"},
    j: {standard: "g", closer: "h"},
    k: {standard: "c", closer: "h"},
    l: {standard: "u"},
    m: {standard: "n", closer: "h"},
    n: {standard: "n"},
    o: {standard: "o"},
    p: {standard: "c", closer: "h"},
    q: {standard: "c", closer: "h"},
    r: {standard: "u"},
    s: {standard: "h"}, 
    t: {standard: "g", closer: "h"},
    u: {standard: "u"},
    v: {standard: "g", closer: "h"},
    w: {standard: "uu"},
    x: {standard: "c", closer: "h"}, 
    y: {standard: "y"},
    z: {standard: "g", closer: "h"},
    // NUMBERS
    0: {standard: "gheuo"},
    1: {standard: "one"},
    2: {standard: "ghuoo"},
