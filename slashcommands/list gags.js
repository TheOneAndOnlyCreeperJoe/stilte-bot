...
module.exports = {
    ...
    run(client, interaction){
        ...
        .setTitle("Gag List")
        .addFields( 
            {name: '**Ball-Gag**', value: 'The default and stereotypical gag. Sounds just like the real-life ball-gag.'},
            {name: '**Ring-Gag**', value: 'A lighter and more understandable gag. Sounds just like the real-life ring-gag.'},
            {name: '**Muzzle**', value: 'A sturdier gag that\'s harder to understand. Sounds just like the real life muzzle gag.'},
